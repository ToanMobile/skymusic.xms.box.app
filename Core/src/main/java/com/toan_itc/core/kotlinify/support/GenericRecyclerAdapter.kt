...
abstract class GenericRecyclerAdapter<E>(context: Context,
        ...
        androidx.recyclerview.widget.RecyclerView.Adapter<GenericRecyclerAdapter<E>.GenericViewHolder>() {

    private var layoutInflater: LayoutInflater = LayoutInflater.from(context)

    //region setup and binding
    inner class GenericViewHolder(private val v: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(v) {
    ...
    override fun onBindViewHolder(holder: GenericViewHolder, position: Int) {
        if (genericList.isNotEmpty() && genericList[position] != null)
            holder.onBind(position, genericList[position]) else Unit
    }
